...
#create use 'e20191250'@'localhost';
#rename user 'e20191250'@'localhost' to 'e20190250'@'%';
#set pasword for 'e20191250'@'%'=PASSWORD'12345'

#TP02 2/10/22

CREATE USER 'e20191250'@'localhost';
RENAME USER 'e20191250'@'localhost' TO 'e20191313'@'%';
SET PASSWORD FOR 'e20191250'@'%'= PASSWORD('12345');
GRANT ALL 
