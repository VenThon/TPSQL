<script>
	...
	import { createChannelRemark } from '$providers/actions/kchannel/channel';
...
{#if shown}
	<div class="flex items-center justify-center w-full h-full">
		<div
			class="  flex flex-col relative bg-white z-50 w-full max-w-lg h-full max-h-[700px]  rounded-lg shadow-md"
		>
			<form
				on:submit|preventDefault={onLoadACreateCardRemark}
